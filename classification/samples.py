...
def _test():
    ...
    n = 5
    items = loadDataFile("/Users/pranoysarath/Downloads/classification/data/facedata/facedatatrain", n,60,70)
    labels = loadLabelsFile("/Users/pranoysarath/Downloads/classification/data/facedata/facedatatrainlabels", n)
    # items = loadDataFile("/Users/pranoysarath/Downloads/classification/data/digitdata/trainingimages", n, 28, 28)
    # labels = loadLabelsFile("/Users/pranoysarath/Downloads/classification/data/digitdata/traininglabels", n)
    # for i in range(1):
    #     print(items[i])
    #     print(items[i])
