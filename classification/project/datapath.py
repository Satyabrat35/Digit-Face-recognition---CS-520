...
class DataPath():
    ...
    def getPath(self ,data_variable_path):
        ...
        if data_variable_path == "TRAINING_DIGIT_DATA_PATH":
            return  absolute_path + "\data\digitdata\\trainingimages"
        ...
        if data_variable_path == "TRAINING_DIGIT_LABEL_PATH":
            return absolute_path + "\data\digitdata\\traininglabels"
        ...
        if data_variable_path == "TEST_DIGIT_DATA_PATH":
            return absolute_path + "\data\digitdata\\testimages"
        ...
        if data_variable_path == "TEST_DIGIT_LABEL_PATH":
            return absolute_path + "\data\digitdata\\testlabels"
        ...
        if data_variable_path == "VALIDATION_DIGIT_DATA_PATH":
            return absolute_path + "\data\digitdata\\validationimages"
        ...
        if data_variable_path == "VALIDATION_DIGIT_LABEL_PATH":
            return absolute_path + "\data\digitdata\\validationlabels"
        ...
        if data_variable_path == "TRAINING_FACE_DATA_PATH":
            return absolute_path + "\data\\facedata\\facedatatrain"
        ...
        if data_variable_path == "TRAINING_FACE_LABEL_PATH":
            return absolute_path + "\data\\facedata\\facedatatrainlabels"
        ...
        if data_variable_path == "TEST_FACE_DATA_PATH":
            return absolute_path + "\data\\facedata\\facedatatest"
        ...
        if data_variable_path == "TEST_FACE_LABEL_PATH":
            return absolute_path + "\data\\facedata\\facedatatestlabels"
        ...
        if data_variable_path == "VALIDATION_FACE_DATA_PATH":
            return absolute_path + "\data\\facedata\\facedatavalidation"
        ...
        if data_variable_path == "VALIDATION_FACE_LABEL_PATH":
            return absolute_path + "\data\\facedata\\facedatavalidationlabels"
